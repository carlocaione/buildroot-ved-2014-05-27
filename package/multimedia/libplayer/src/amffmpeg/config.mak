...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-yasm --enable-debug --disable-ffplay --disable-ffmpeg --cross-prefix=arm-linux-gnueabi- --enable-cross-compile --target-os=linux --arch=arm --disable-librtmp --disable-static --enable-shared --disable-ffplay --disable-ffserver --disable-doc
...
EXTRALIBS=-lrt -ldl -lm -pthread -L$(SHLIBDIR) -lamavutils
INSTALL=install
LIBTARGET=
